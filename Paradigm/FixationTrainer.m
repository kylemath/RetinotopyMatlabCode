...
Parameters.Vols_per_Cycle=18  ;   % Volumes per cycle 

%% Background
load(Stim);
Parameters.Stimulus=Stimulus;
Parameters.Refreshs_per_Stim=1   ;  % How many screen refreshed before background flips
Parameters.Rotate_Stimulus=false;   % Image rotates
Parameters.Sine_Rotation=0;  % No rotation back & forth 

%% apature stuff
Parameters.Apperture_Width=360 ;  % Width of wedge in degrees
