...
%         %Trigger BOXY aux channel, EEG marker
%         outp(address_eros,18);  %TMS is only the 8th pin
%         outp(address_eeg,18);  %TMS is only the 8th pin
%         WaitSecs(.05);
